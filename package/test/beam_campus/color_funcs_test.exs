defmodule BCUtils.ColorFuncsTest do
  @moduledoc """
    This module contains tests for the BCUtils.ColorFuncs module.
  """
  use ExUnit.Case
  @tag :bc_color_funcs
  @tag :bc_docs
  doctest BCUtils.ColorFuncs
  ...
  describe "black_on_white/0" do
    ...
    test "GIVEN we start with a black background and a white foreground
      ...
      assert BCUtils.ColorFuncs.black_on_white() == "\e[30m\e[47m"
    end
    ...
    test "GIVEN we start with a black background and a white foreground
      ...
      assert BCUtils.ColorFuncs.red_on_black() == "\e[31m\e[40m"
    end
  end
end
